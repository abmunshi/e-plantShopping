    ...
    >
      <ModalContent>
        <div className="bg-white w-20 h-20 rounded-full grid place-content-center relative mx-auto overflow-hidden">
          ...
          <div class="loader w-[74px] border-8 border-[#F2EAD3] border-r-primary-600 rounded-full aspect-1 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "></div>
        </div>
      </ModalContent>
